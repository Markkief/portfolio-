			...
			<div class="col-lg-10">
				<div class="card shadow-sm border-0">
					<div class="card-body p-4 p-md-5">
						...
						<form method="post" action="updateimmobile" class="needs-validation" novalidate>
								...
								<div class="card-body">
									...
									<div class="row g-3">
										<div class="col-md-6">
											...
											<select name="idComune" class="form-select" id="idComune" required>
												<option value="">Seleziona città</option>
												<% for(Comune x : comuni){ %>
													<option value="<%=x.getIdComune() %>"><%=x.getNomeComune() %></option>
												<% } %>
											</select>
										</div>
										<div class="col-md-6">
											<label for="idProvincia" class="form-label">Provincia</label>
											<select name="idProvincia" class="form-select" id="idProvincia" required>
												<option value="">Seleziona provincia</option>
												<% for(Provincia x : provincie){ %>
													<option value="<%=x.getIdProvincia()%>"><%=x.getNomeProvincia()%></option>
												<% } %>
											</select>
										</div>
										<div class="col-12">
							...
							<div class="text-center">
								<button type="submit" class="btn btn-primary btn-lg px-5">
									<i class="bi bi-check-circle me-2"></i>Aggiorna Annuncio
								</button>
							</div>
						</form>
					</div>
